...
mkValidator dat () ctx = (traceIfFalse "beneficiary 1's signature missing" signedByBeneficiary1 && 
                         traceIfFalse "deadline not reached for beneficiary1" deadlineReached1) ||
                         (traceIfFalse "beneficiary 2's signature missing" signedByBeneficiary2 &&
                         traceIfFalse "deadline not reached for beneficiary2" deadlineReached2)
    ...
    where
        ...
        deadlineReached2 = contains (from $ deadline dat) $ txInfoValidRange info
